        ...
        <div class="row subtitle-row" style="text-align: left;font-size: 18px;">
            ...
            <div class="col-sm-6 onlyone" data-style='bounceInRight'>
                <div class="col-sm-6 hover1">
                    <img src="<?php echo e(base_url()); ?>public/images/22.jpg" style="border-radius: 15px;"/>
                </div>
                <div class="col-sm-6">
                    <h3 style="color:greenyellow;    font-weight: bold;">Mô tả</h3>
                    <p style="font-size: 13px;"><img src="<?php echo e(base_url()); ?>public/images/dientich.png"><b>Tổng diện tích: </b><i>82.5ha</i></p>
                    <p style="font-size: 13px;"><img src="<?php echo e(base_url()); ?>public/images/cay.png"><b>Khuôn viên cây xanh:</b> <i>16.4ha</i></p>
                    <p style="font-size: 13px;"><img src="<?php echo e(base_url()); ?>public/images/xay.png"><b>Mật độ xây dựng:</b> <i>20%</i></p>
            ...
            <div class="col-sm-12 text-center onlyone" data-style="fadeIn"><img class="img-responsive"src="<?php echo e(base_url()); ?>public/images/map.gif" /></div>
        ...
        <ul class="timeline">
            <li class="onlyone"data-style='bounceInLeft'>
                <div class="timeline-image hover1">
                    <img src="<?php echo e(base_url()); ?>public/images/24.jpg" alt="">
                </div>
            ...
            <li class="timeline-inverted onlyone"data-style='bounceInRight'>
                <div class="timeline-image hover1">
                    <img class="" src="<?php echo e(base_url()); ?>public/images/map.gif" alt="">
                </div>
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <h4 class="subheading">
            ...
            <li class="onlyone" data-style='bounceInLeft'>
                <div class="timeline-image hover1">
                    <img class="img-circle img-responsive" src="<?php echo e(base_url()); ?>public/images/logo.png" alt="">
                </div>
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <h4 class="subheading">
            ...
            <li class="timeline-inverted onlyone"data-style='bounceInRight'>
                <div class="timeline-image hover1">
                    <img class="img-circle img-responsive" src="<?php echo e(base_url()); ?>public/images/35.jpg" alt="">
                </div>
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <h4 class="subheading">
            ...
            <li class="onlyone"data-style='bounceInLeft'>
                <div class="timeline-image hover1">
                    <img class="img-circle img-responsive" src="<?php echo e(base_url()); ?>public/images/4.jpg" alt="">
                </div>
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <h4 class="subheading">
            ...
            <li class="timeline-inverted onlyone"data-style='bounceInRight'>
                <div class="timeline-image hover1">
                    <img class="img-circle img-responsive" src="<?php echo e(base_url()); ?>public/images/25.jpg" alt="">
                </div>
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <h4 class="subheading">
