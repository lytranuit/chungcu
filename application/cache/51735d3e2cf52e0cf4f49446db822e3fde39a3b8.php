<form method="POST" action="" id="form-dang-tin" style="margin: 20px 0px;">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-12 tieude parent">
            ...
            <input type="text" name="post_titles" class="form-control" placeholder="Tiêu đề" value="<?php echo e($tin['title']); ?>" required=""/>
        </div>
        <div class="form-group col-md-12 noidung parent">
            <label for="post_contents">
                Nội dung 
            </label><span class="text-danger">*</span><span class="error-place"></span>
            <textarea name="post_contents" class="form-control" id="edit"required=""><?php echo e($tin['content']); ?></textarea>
        </div>
        <div class="form-group col-md-6 parent">
            ...
            <select name="post_tp" ajax="" class="post_tp form-control" required="">
                ...
                <?php if($row['id_khuvuc'] == $tin['thanhpho']): ?>
                <option value='<?php echo e($row['id_khuvuc']); ?>'  selected=""><?php echo e($row['ten_khuvuc']); ?></option>
                <?php else: ?>
        ...
        <div class="form-group col-md-6 parent">
            ...
            <select name="post_quan" class="post_quan form-control" required="">
                <?php foreach($quan as $row): ?>
                <?php if($row['id_khuvuc'] == $tin['quan']): ?>
                <option value='<?php echo e($row['id_khuvuc']); ?>'selected=""><?php echo e($row['ten_khuvuc']); ?></option>
                <?php else: ?>
                <option value='<?php echo e($row['id_khuvuc']); ?>'><?php echo e($row['ten_khuvuc']); ?></option>
                <?php endif; ?>
        ...
        <div class="form-group col-md-4 parent">
            ...
            <input name="diachi" class="diachi form-control" required="" value="<?php echo e($tin['diachi']); ?>"/>
        </div>
        <div class="form-group col-md-4 parent">
            <label>
                Diện tích (m2):
            </label><span class="text-danger">*</span><span class="error-place"></span>
            <input name="dientich" class="dien-tich form-control" required="" value='<?php echo e($tin['dientich']); ?>'/>
        </div>
        <div class="form-group col-md-4 parent">
            <label>
                Giá tiền (triệu đồng):
            </label><span class="text-danger">*</span><span class="error-place"></span>
            <input name="gia_ban" class="gia form-control" required="" value="<?php echo e($tin['gia']); ?>"/>
        </div>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-sm-12 col-md-6 parent">
            ...
            <input name="chieudai" class="form-control chieudai" value="<?php echo e($tin['chieudai']); ?>"/>
        </div>
        <div class="form-group col-sm-12 col-md-6 parent">
            <label>
                Chiều rộng
            </label><span class="error-place"></span>
            <input name="chieurong" class="form-control chieurong" value="<?php echo e($tin['chieurong']); ?>"/>
        </div>
        <div class="form-group col-sm-12 col-md-6 parent">
            <label>
                Hướng
            ...
            <select name="huong" class="form-control">
                ...
                <?php if($row['id_huong'] == $tin['id_huong']): ?>
                <option value='<?php echo e($row['id_huong']); ?>' selected=""><?php echo e($row['ten_huong']); ?></option>
                <?php else: ?>
        ...
        <div class="form-group col-sm-12 col-md-6 parent">
            ...
            <select name="phaply" class="form-control">
                ...
                <?php if($row['id_phaply'] == $tin['id_phaply']): ?>
                <option value='<?php echo e($row['id_phaply']); ?>' selected=""><?php echo e($row['ten_phaply']); ?></option>
                <?php else: ?>
...
<?= $htmlcon ?>
    ...
    function get_quan_huyen(parent) {
        ...
        $.ajax({
            type: 'GET',
            data: {parent: parent},
            url: '<?php echo e(base_url()); ?>ajax/get_quan_huyen',
