    ...
    <table id="quanlytin" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php if($tin->active): ?>
                    <a href="<?php echo e(base_url()); ?>member/deactivate_tin/<?php echo e($tin->id_tin); ?>">
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(base_url()); ?>member/activate_tin/<?php echo e($tin->id_tin); ?>">
                ...
                <td>
                    <a href="<?php echo e(base_url()); ?>member/edittin/<?php echo e($tin->id_tin); ?>">
                        <button class="btn btn-xs btn-info">
                            <i class="ace-icon fa fa-pencil bigger-120">
                            </i>
                        </button>
                    </a>
                    <a href="<?php echo e(base_url()); ?>member/remove_tin/<?php echo e($tin->id_tin); ?>">
                        <button class="btn btn-xs btn-danger">
