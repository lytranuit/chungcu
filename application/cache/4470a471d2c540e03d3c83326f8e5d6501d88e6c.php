<form method="POST" action="" id="form-gioithieu" style="margin: 20px 0px;">
    ...
    <input name="id" hidden="" value="<?php echo e($gioithieu['id_option']); ?>"/>
    <div class="form-group col-md-12 noidung parent">
        <label for="post_contents"></label>
        <span class="error-place"></span>
        <textarea name="post_contents" class="form-control" id="edit"required=""><?php echo e($gioithieu['content']); ?></textarea>
    </div>
    <div class="col-md-12">
