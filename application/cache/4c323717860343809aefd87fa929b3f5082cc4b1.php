<div id="signinbox" class="mainbox col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2"> 
    <form name="form" id="form-signin" action="<?php echo e(base_url()); ?>index/signin" class=""method="POST">
        ...
        $("#form-signin").validate({
            rules: {
                email: {
                    required: true,
                    email: true,
                    remote: '<?php echo e(base_url()); ?>index/checkEmail'
                },
                username: {
                    required: true,
                    remote: '<?php echo e(base_url()); ?>index/checkUsername'
                },
                confirmemail: {
