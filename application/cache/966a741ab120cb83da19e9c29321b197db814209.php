<form name="form" id="form-edit-user" action="<?php echo e(base_url()); ?>member" class=""method="POST">
    ...
    <div class="col-md-12">
        <div class="form-group col-md-6 parent">
            ...
            <input type="text" name="username" class="form-control" placeholder="VD: daotran" disabled="" value="<?php echo e($user['username']); ?>"/>
        </div>
        <div class="form-group col-md-6 parent">
            <label for="ten">
                Họ và Tên
            </label><span class="text-danger">*</span><span class="error-place"></span>
            <input type="text" name="ten" class="form-control" placeholder="VD: Đào Lý Trân" required="" value="<?php echo e($user['last_name']); ?>"/>
        </div>
        ...
        <div class="form-group col-md-12 parent">
            ...
            <input type="email" name="email" class="form-control" placeholder="VD:abc@gmail.com" value="<?php echo e($user['email']); ?> "disabled=""/>
        </div>
        <div class="form-group col-md-12 parent">
            <label for="gioitinh">
                Giới tính
        ...
        <div class="form-group col-md-12 parent">
            ...
            <input type="number" name="dienthoai" class="form-control" placeholder="VD:01224545275" value="<?php echo e($user['phone']); ?>"/>
        </div>
        <div class="col-md-12">
            <a class="" href="<?php echo e(base_url()); ?>member/changepass"> <i class="glyphicon glyphicon-lock"></i> Thay đổi mật khẩu</a>
        </div>
