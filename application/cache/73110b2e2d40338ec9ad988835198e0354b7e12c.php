...
<div class="col-md-12 alert box-<?php echo e($id); ?>">
    ...
    <div class="col-md-12">
        <div class="form-group">
            <input id="hinh-anh<?php echo e($id); ?>" name="hinhanh[]" type="file" multiple class="file">
        </div>
    </div>
    ...
    <script type="text/javascript">
        $("#hinh-anh<?php echo e($id); ?>").fileinput({
        ...
        $("#hinh-anh<?php echo e($id); ?>").on('fileuploaded', function (event, data, previewId, index) {
            var id = data.response.key;
            var add = "<input type='hidden' name='id_hinhanh[]' value='" + id + "' class='hinhanh'>";
            $("#form-slider .box-<?php echo e($id); ?>").append(add);
        });
        $('#hinh-anh<?php echo e($id); ?>').on('filedeleted', function (event, key) {
